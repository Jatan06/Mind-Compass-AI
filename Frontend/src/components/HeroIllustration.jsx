...
export const HeroIllustration = () => {
    return (
        ...
        >
            ...
            {/* Botanical Elements: Minimalist left branch & leaves */}
            <path
            ...
            {/* Botanical Elements: Minimalist right floral branch & leaves */}
            <path
            ...
            {/* Decorative Details: Floating organic seeds/particles */}
